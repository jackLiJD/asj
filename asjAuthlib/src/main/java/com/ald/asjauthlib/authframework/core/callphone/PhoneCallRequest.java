...
public class PhoneCallRequest implements Serializable {
    ...
    protected PhoneCallRequest() {
    }

    public PhoneCallRequest(String phone, String group, String source) {
        this(phone, group, source, null);
    }

    public PhoneCallRequest(String phone, String group, String source, String label) {
        this(phone, group, source, label, null);
    }

    public PhoneCallRequest(String phone, String group, String source, String label, String extra) {
    ...
    public PhoneCallRequest(PhoneCallRequest from) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PhoneCallRequest)) {
            return false;
        }

        PhoneCallRequest request = (PhoneCallRequest) o;

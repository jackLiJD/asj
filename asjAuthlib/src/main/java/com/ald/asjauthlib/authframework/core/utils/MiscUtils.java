...
public class MiscUtils {
    ...
    public static int getResourcesIdentifier(Context context, String fullname) {
        return AlaConfig.getResources().getIdentifier(context.getPackageName() + ":" + fullname, null, null);
    }
    ...
    private static boolean isLocationProviderEnabled(String provider) {
        LocationManager lm = (LocationManager) AlaConfig.getContext().getSystemService(Context.LOCATION_SERVICE);
    ...
    public static String getSharepreferenceValue(String shareName, String key, String defaultValue) {
        SharedPreferences share = AlaConfig.getContext().getSharedPreferences(shareName, Context.MODE_PRIVATE);
...
//        return  phone.replaceAll("(\\d{3})\\d{4}(\\d{4})", "$1****$2");
    ...
    public static Bitmap readBitmap(Context context, int resId) {
        ...
        // 获取资源图片
        InputStream is = AlaConfig.getResources().openRawResource(resId);
    ...
    */
    ...
    public static void hideKeyBoard(View view) {
        InputMethodManager imm = (InputMethodManager) AlaConfig.getContext()
    ...
    public static void initWebView(Context context) {
        ...
        webView.getSettings()
                .setDatabasePath(AlaConfig.getContext().getDir("database", Context.MODE_PRIVATE).getPath());
        webView.getSettings().setAppCachePath(AlaConfig.getContext().getDir("cache", Context.MODE_PRIVATE).getPath());
    }
    ...
    public static void enableHTML5(WebView webView, boolean netFirst) {
        ...
        webView.setDownloadListener(new DownloadListener() {
            ...
            public void onDownloadStart(String url, String userAgent, String contentDisposition, String mimetype,
                                        long contentLength) {
                MiscUtils.goToSite(AlaConfig.getCurrentActivity(), url);
            }
        });

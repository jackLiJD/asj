...
public class AlaProtocol {
    ...
    public static final String GROUP_ZMXY = "/third/zm/authNotify";
    ...
    public static final String ROOT_H5_HOST = "51fanbei";//包含爱上街域名的
    public static final String ROOT_IP = "192.168";//包含爱上街域名的
    public static final String ROOT_IP1 = "172.20";//包含爱上街域名的
    ...
    public interface Protocol {
        ...
        String TOOL_BAR = ROOT_WEB_PATH + "/toolbar";
        //芝麻信用接口的回调参数
        String ZMXY_KEY = "/third/zm/authNotify";
        //手机运营商提交数据
        String MOBILE_SUCCESS_KEY = "/app/sys/mobileOperator";
        //手机运营商提交数据返回
        String MOBILE_BACK_KEY = "/app/sys/authBack";
        //分享按钮
        String SHOW_SHARE_ICON = "addUiName=SHOWSHARE";
        //更多优惠卷按钮
        String SHOW_COUPON_TEXT = "addUiName=COUPONS";
        //搜索
        String APP_SEARCH = "APP_SEARCH";
        //搜索按钮
        String SHOW_SEARCH_ICON = "addRightUiName=SEARCH";
        // 51公积金
        String WUYAO_FUND_STATUS = "/newFund/giveBack";
        //公信宝标识
        String GXB_BACK = "gxbdata/alipay/notify";

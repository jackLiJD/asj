...
public class ArcLinearLayout extends LinearLayout {
    ...
    public ArcLinearLayout(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ArcLinearLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {

...
public class InfoUtils {
    ...
    public static String getAppName() {
        try {
            ApplicationInfo info = AlaConfig.getContext().getPackageManager()
                    .getApplicationInfo(AlaConfig.getContext().getPackageName(), PackageManager.GET_META_DATA);
            CharSequence name = info.loadLabel(AlaConfig.getContext().getPackageManager());
    ...
    public static String getVersionName() {
        try {
            versionName = AlaConfig.getContext().getPackageManager()
                    .getPackageInfo(AlaConfig.getContext().getPackageName(), 0).versionName;
    ...
    public static int getVersionCode() {
        int versionCode = 100;
        try {
            String versionName = AlaConfig.getContext().getPackageManager()
                    .getPackageInfo(AlaConfig.getContext().getPackageName(), 0).versionName;
    ...
    public static String getNetworkType() {
        ...
        if (InfoUtils.isConnectAvailable()) {
            ConnectivityManager manager = (ConnectivityManager) AlaConfig.getContext()
    ...
    public static boolean isConnectAvailable() {
        ConnectivityManager cm = (ConnectivityManager) AlaConfig.getContext()
                .getSystemService(Context.CONNECTIVITY_SERVICE);
        if (cm == null) {
            return false;
        }
    ...
    public static String getNetworkName() {
        TelephonyManager phone = (TelephonyManager) AlaConfig.getContext().getSystemService(TELEPHONY_SERVICE);
    ...
    public static String getRequestId(String ts) {
        ...
        String packageName = AlaConfig.getContext().getPackageName();
        String channel = "";
        if (MiscUtils.isNotEmpty(packageName)) {
            String mark = packageName.substring(packageName.lastIndexOf(".")).replace(".", "");
            return requestId + mark + "_" + channel;
        }
        return requestId + packageName + "_" + channel;
    }
    ...
    public static String getDeviceId() {
        String deviceId = "";
        TelephonyManager tm = (TelephonyManager) AlaConfig.getContext().getSystemService(TELEPHONY_SERVICE);
        try {
            /*deviceId = tm.getDeviceId();
            if (MiscUtils.isEmpty(deviceId) || deviceId.length() <= 5) {
                final SharedPreferences prefs = AlaConfig.getContext().getSharedPreferences(PREFS_FILE, 0);
    ...
    public static String generateUniqueDeviceId() {
        Application context = AlaConfig.getContext();
        String imei = "";
        String androidId = "";
        String macAddress = "";
    ...
    public static String getIMEI() {
        TelephonyManager telephonyManager = (TelephonyManager) AlaConfig.getContext()
    ...
    public static String getIp() {
        NetworkInfo info = ((ConnectivityManager) AlaConfig.getContext().getApplicationContext()
        ...
        if (info != null && info.isConnected()) {
            ...
            if (info.getType() == ConnectivityManager.TYPE_MOBILE) {
                ...
                WifiManager wifiManager = (WifiManager) AlaConfig.getContext().getApplicationContext().getSystemService(Context.WIFI_SERVICE);

package com.ald.asjauthlib.authframework.core.ui.statusbar;
...
public class StatusBarUtil {
    ...
    public static int getStatusBarHeight(Context context) {
        // 获得状态栏高度
        int resourceId = AlaConfig.getResources().getIdentifier("status_bar_height", "dimen", "android");
        return AlaConfig.getResources().getDimensionPixelSize(resourceId);
    }

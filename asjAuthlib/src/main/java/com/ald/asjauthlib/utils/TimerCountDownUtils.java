...
public abstract class TimerCountDownUtils extends CountDownTimer {
     ...
     */
    public TimerCountDownUtils(long millisInFuture, long countDownInterval) {
    ...
    public String toClock(long millisUntilFinished, boolean isBrand,String txt) {
        ...
        if (isBrand) {
            ...
            return showHour + ":" + showMinute + ":" + showSecond + txt;
        }
    }

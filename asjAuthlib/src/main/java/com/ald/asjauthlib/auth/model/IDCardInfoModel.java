...
public class IDCardInfoModel implements Parcelable {
    ...
    protected IDCardInfoModel(Parcel in) {
        cardInfo = in.readParcelable(CardInfo.class.getClassLoader());
        list = in.readArrayList(Img.class.getClassLoader());
    }

    public static final Creator<IDCardInfoModel> CREATOR = new Creator<IDCardInfoModel>() {
        @Override
        public IDCardInfoModel createFromParcel(Parcel in) {
            return new IDCardInfoModel(in);
        }

        @Override
        public IDCardInfoModel[] newArray(int size) {
            return new IDCardInfoModel[size];
        }
    };

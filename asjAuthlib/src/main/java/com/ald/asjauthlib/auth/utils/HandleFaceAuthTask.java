...
public class HandleFaceAuthTask extends AsyncTask<String, Integer, Long> {
    ...
    public HandleFaceAuthTask(Activity context) {
        this.context = context;
    }


    public HandleFaceAuthTask setAuthType(String authType) {
        this.authType = authType;
        return this;
    }

    public HandleFaceAuthTask setCallBack(HandleAuthCallBack callBack) {

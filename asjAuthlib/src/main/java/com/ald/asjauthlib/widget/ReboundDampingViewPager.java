...
/**
 * Created by wjy on 2017/12/15.
 */

public class ReboundDampingViewPager extends ViewPager {
    ...
    public ReboundDampingViewPager(Context context) {
        super(context);
    }

    public ReboundDampingViewPager(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

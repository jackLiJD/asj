...
public class ShadowLayout extends RelativeLayout {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        float effect = mShadowRadius + dip2px(0);
        float rectLeft = 0;
        float rectTop = 0;
    ...
    public void setShadowRadius(int shadowRadius) {
        mShadowRadius = dip2px(shadowRadius);
        requestLayout();
        postInvalidate();
    }
    ...
    private void init(AttributeSet attrs) {
        ...
        if (typedArray != null) {
            mShadowColor = typedArray.getColor(R.styleable.ShadowLayout_shadow_Color,
    ...
    public void setmShadowDy(int shadowDy) {
        this.mShadowDy = dip2px(shadowDy);
    }
}

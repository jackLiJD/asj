...
import com.ald.asjauthlib.cashier.viewmodel.MyTicketsChildVM;
import com.ald.asjauthlib.databinding.FragmentMyTicketsListBinding;
...
public class MyTicketFragment extends AlaBaseFragment<FragmentMyTicketsListBinding> {
    ...
    protected void initViews() {
        vm = new MyTicketsChildVM(this, ticketType);
        cvb.setViewModel(vm);
